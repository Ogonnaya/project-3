...
var _default = ({
  ...
  return {
    ...
    plugins: [stories && stories.length ? new _webpackVirtualModules.default({
      [_path.default.resolve(_path.default.join(configDir, `generated-entry.js`))]: `
              import { configure } from '@storybook/${framework}';
              module._StorybookPreserveDecorators = true;

              configure([${stories.map(_toRequireContext.toRequireContextString).join(',')}
              ], module);
            `
