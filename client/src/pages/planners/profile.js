...
class profile extends Component {
    ...
    loadPlanners = () => {
        API.getPlanners()
            .then(res =>
                this.setState({ planners: res.data })
            )
                ...
                {this.state.planners.map((planner, i) =>
                    <Media>
                        ...
                        <Media body>
                            ...
                            <p>Bio: Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
...
export default profile;
>>>>>>> 6261a62810a336649561e8a65883cc6c45c27e0c
